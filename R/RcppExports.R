...
#' 
#' @export
sarim_gibbs_kappasamples <- function(y, Z, K, K_rank, gamma, ka_start, ka_values, solver, lin_constraint, sigma, sigma_values, nIter, m, thr, display_progress = TRUE) {
    .Call('_Sarim_sarim_gibbs_kappasamples', PACKAGE = 'Sarim', y, Z, K, K_rank, gamma, ka_start, ka_values, solver, lin_constraint, sigma, sigma_values, nIter, m, thr, display_progress)
}
...
#' 
#' @export
sarim_mcmc_kappasamples <- function(y, Z, K, K_rank, gamma, ka_start, ka_values, solver, lin_constraint, family, link, nIter, burnin, Ntrials, m, thr, gammamean, gamma2mean, kappamean, kappa2mean, iterationcounter, display_progress = TRUE) {
    .Call('_Sarim_sarim_mcmc_kappasamples', PACKAGE = 'Sarim', y, Z, K, K_rank, gamma, ka_start, ka_values, solver, lin_constraint, family, link, nIter, burnin, Ntrials, m, thr, gammamean, gamma2mean, kappamean, kappa2mean, iterationcounter, display_progress)
}
...
#' 
#' @export
sarim_mcmc_nosamples <- function(y, Z, K, K_rank, gamma, ka_start, ka_values, solver, lin_constraint, family, link, nIter, burnin, Ntrials, m, thr, gammamean, gamma2mean, kappamean, kappa2mean, iterationcounter, display_progress = TRUE) {
    .Call('_Sarim_sarim_mcmc_nosamples', PACKAGE = 'Sarim', y, Z, K, K_rank, gamma, ka_start, ka_values, solver, lin_constraint, family, link, nIter, burnin, Ntrials, m, thr, gammamean, gamma2mean, kappamean, kappa2mean, iterationcounter, display_progress)
}
