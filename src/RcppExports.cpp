...
// sarim_gibbs_kappasamples
Rcpp::List sarim_gibbs_kappasamples(const Eigen::Map<Eigen::VectorXd>& y, const Rcpp::List& Z, const Rcpp::List& K, const Rcpp::List& K_rank, const Rcpp::List& gamma, const Rcpp::List& ka_start, const Rcpp::List& ka_values, const Rcpp::List& solver, const Rcpp::List& lin_constraint, const double& sigma, const Eigen::Map<Eigen::VectorXd>& sigma_values, const int& nIter, const int& m, const double& thr, const bool& display_progress);
RcppExport SEXP _Sarim_sarim_gibbs_kappasamples(SEXP ySEXP, SEXP ZSEXP, SEXP KSEXP, SEXP K_rankSEXP, SEXP gammaSEXP, SEXP ka_startSEXP, SEXP ka_valuesSEXP, SEXP solverSEXP, SEXP lin_constraintSEXP, SEXP sigmaSEXP, SEXP sigma_valuesSEXP, SEXP nIterSEXP, SEXP mSEXP, SEXP thrSEXP, SEXP display_progressSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::VectorXd>& >::type y(ySEXP);
    ...
    Rcpp::traits::input_parameter< const double& >::type thr(thrSEXP);
    Rcpp::traits::input_parameter< const bool& >::type display_progress(display_progressSEXP);
    rcpp_result_gen = Rcpp::wrap(sarim_gibbs_kappasamples(y, Z, K, K_rank, gamma, ka_start, ka_values, solver, lin_constraint, sigma, sigma_values, nIter, m, thr, display_progress));
    return rcpp_result_gen;
END_RCPP
}
// sarim_mcmc
...
// sarim_mcmc_kappasamples
Rcpp::List sarim_mcmc_kappasamples(const Eigen::Map<Eigen::VectorXd>& y, const Rcpp::List& Z, const Rcpp::List& K, const Rcpp::List& K_rank, const Rcpp::List& gamma, const Rcpp::List& ka_start, const Rcpp::List& ka_values, const Rcpp::List& solver, const Rcpp::List& lin_constraint, const Rcpp::String& family, const Rcpp::String& link, const int& nIter, const int& burnin, const double& Ntrials, const int& m, const double& thr, const Rcpp::List& gammamean, const Rcpp::List& gamma2mean, const Rcpp::List& kappamean, const Rcpp::List& kappa2mean, const int& iterationcounter, const bool& display_progress);
RcppExport SEXP _Sarim_sarim_mcmc_kappasamples(SEXP ySEXP, SEXP ZSEXP, SEXP KSEXP, SEXP K_rankSEXP, SEXP gammaSEXP, SEXP ka_startSEXP, SEXP ka_valuesSEXP, SEXP solverSEXP, SEXP lin_constraintSEXP, SEXP familySEXP, SEXP linkSEXP, SEXP nIterSEXP, SEXP burninSEXP, SEXP NtrialsSEXP, SEXP mSEXP, SEXP thrSEXP, SEXP gammameanSEXP, SEXP gamma2meanSEXP, SEXP kappameanSEXP, SEXP kappa2meanSEXP, SEXP iterationcounterSEXP, SEXP display_progressSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::VectorXd>& >::type y(ySEXP);
    ...
    Rcpp::traits::input_parameter< const int& >::type iterationcounter(iterationcounterSEXP);
    Rcpp::traits::input_parameter< const bool& >::type display_progress(display_progressSEXP);
    rcpp_result_gen = Rcpp::wrap(sarim_mcmc_kappasamples(y, Z, K, K_rank, gamma, ka_start, ka_values, solver, lin_constraint, family, link, nIter, burnin, Ntrials, m, thr, gammamean, gamma2mean, kappamean, kappa2mean, iterationcounter, display_progress));
    return rcpp_result_gen;
END_RCPP
}
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const int& >::type iterationcounter(iterationcounterSEXP);
    Rcpp::traits::input_parameter< const bool& >::type display_progress(display_progressSEXP);
    rcpp_result_gen = Rcpp::wrap(sarim_mcmc_nosamples(y, Z, K, K_rank, gamma, ka_start, ka_values, solver, lin_constraint, family, link, nIter, burnin, Ntrials, m, thr, gammamean, gamma2mean, kappamean, kappa2mean, iterationcounter, display_progress));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_Sarim_sarim_gibbs_kappasamples", (DL_FUNC) &_Sarim_sarim_gibbs_kappasamples, 15},
    {"_Sarim_sarim_mcmc", (DL_FUNC) &_Sarim_sarim_mcmc, 22},
    {"_Sarim_sarim_mcmc_kappasamples", (DL_FUNC) &_Sarim_sarim_mcmc_kappasamples, 22},
    {"_Sarim_sarim_mcmc_nosamples", (DL_FUNC) &_Sarim_sarim_mcmc_nosamples, 22},
    {NULL, NULL, 0}
};
