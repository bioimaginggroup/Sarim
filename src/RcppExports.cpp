...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const int& >::type iterationcounter(iterationcounterSEXP);
    Rcpp::traits::input_parameter< const bool& >::type display_progress(display_progressSEXP);
    rcpp_result_gen = Rcpp::wrap(sarim_mcmc_nosamples(y, Z, K, K_rank, gamma, ka_start, ka_values, solver, lin_constraint, family, link, nIter, burnin, Ntrials, m, thr, gammamean, gamma2mean, gamma3mean, kappamean, kappa2mean, kappa3mean, iterationcounter, display_progress));
    return rcpp_result_gen;
END_RCPP
}
