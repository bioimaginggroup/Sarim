...
Rcpp::List sarim_mcmc_nosamples(const Eigen::Map<Eigen::VectorXd> & y,
     ...
     Rcpp::List gamma_mean=gammamean;
     Rcpp::List gamma_mean2=gamma2mean;        // squared mean for gamma values
     Rcpp::List gamma_mean3=gamma3mean;        // cubic mean for gamma values
     Rcpp::List kappa_mean=kappamean;        // mean for kappa values
     Rcpp::List kappa_mean2=kappa2mean;        // squared mean for kappa values
     Rcpp::List kappa_mean3=kappa3mean;        // cubic mean for kappa values
     ...
     for (int i = 0; i < p; ++i) {
         ...
         Eigen::VectorXd kappa_results_tmp(1);
